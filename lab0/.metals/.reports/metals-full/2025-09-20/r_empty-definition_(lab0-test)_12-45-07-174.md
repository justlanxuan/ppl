file://<WORKSPACE>/src/test/scala/lab0/ListsSuite.scala
...
non-local guesses:
	 ...
	 -Lists.List#
	 -Lists.List().
	 -scala/concurrent/duration/List.
	 -scala/concurrent/duration/List#
	 -scala/concurrent/duration/List().
	 -List.
	 -List#
	 ...
	 -scala/Predef.List().
offset: 3363
uri: file://<WORKSPACE>/src/test/scala/lab0/ListsSuite.scala
text:
```scala
package lab0
